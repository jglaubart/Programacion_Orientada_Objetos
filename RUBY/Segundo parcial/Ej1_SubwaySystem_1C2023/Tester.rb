...
require_relative 'stated_subway_system'
...
baires.lines.sort.each { |line| puts line }    #---> Hace sort por lo que deben ser comparables, pero no tienen que estar ordenadas previamente
# Subway Line A
# Subway Line H


# Se itera por las estaciones de la línea A en orden alfabético por estación
baires.stations('A').each { |station| puts station }  #---> ordenadas previamente, sortedSet
# Subway Station Alberti
# Subway Station Plaza de Mayo


# El metodo stations retorna nil si la línea no existe y no se puede iterar
...
# a las que pertenecen, que inicialmente arranca sin líneas y sin estaciones
baires_st = StatedSubwaySystem.new('Buenos Aires')
